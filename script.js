  ...
  // Ambient cursor light — desktop/mouse only, skipped on touch devices to save battery
    ...
    window.addEventListener('mousemove', (e) => {
      if (!ticking) {
        requestAnimationFrame(() => {
          light.style.background = `radial-gradient(650px circle at ${e.clientX}px ${e.clientY}px, rgba(16,185,129,0.07), transparent 40%)`;
          ticking = false;
        });
        ticking = true;
      }
